...
public class ItemRegistry {
    ...
    public static Item CRYSTALLINE_DUST;
    public static Item CRYSTALLINE_INGOT;
    public static Item CRYSTALLINE_PLATE;
    public static Item CRYSTALLINE_NUGGET;
    public static Item CRYSTALLINE_BOOTS;
    public static Item CRYSTALLINE_CHEST;
    public static Item CRYSTALLINE_HELMET;
    public static Item CRYSTALLINE_LEGS;
    public static Item CRYSTALLINE_AXE;
    public static Item CRYSTALLINE_HAMMER;
    public static Item CRYSTALLINE_HOE;
    public static Item CRYSTALLINE_PICK;
    public static Item CRYSTALLINE_SAW;
    public static Item CRYSTALLINE_SHOVEl;
    public static Item CRYSTALLINE_SWORD;
    ...
    public static void registry(RegistryEvent.Register<Item> e) {
        ...
        CRYSTALLINE_DUST = register(new Item(new Item.Properties().group(ExpertModeCore.main)).setRegistryName("crystalline_dust"), e);
        CRYSTALLINE_INGOT = register(new Item(new Item.Properties().group(ExpertModeCore.main)).setRegistryName("crystalline_ingot"), e);
        CRYSTALLINE_PLATE = register(new Item(new Item.Properties().group(ExpertModeCore.main)).setRegistryName("crystalline_plate"), e);
        CRYSTALLINE_NUGGET = register(new Item(new Item.Properties().group(ExpertModeCore.main)).setRegistryName("crystalline_nugget"), e);
        CRYSTALLINE_BOOTS = register(new ModArmor(ExpertMaterials.CRYSTALLINE, EntityEquipmentSlot.FEET), e);
        CRYSTALLINE_CHEST = register(new ModArmor(ExpertMaterials.CRYSTALLINE, EntityEquipmentSlot.CHEST), e);
        CRYSTALLINE_HELMET = register(new ModArmor(ExpertMaterials.CRYSTALLINE, EntityEquipmentSlot.HEAD), e);
        CRYSTALLINE_LEGS = register(new ModArmor(ExpertMaterials.CRYSTALLINE, EntityEquipmentSlot.LEGS), e);
        CRYSTALLINE_AXE = register(new ModAxe(ExpertTiers.CRYSTALLINE, 5, -3), e);
        CRYSTALLINE_HAMMER = register(new ModHammer(ExpertTiers.CRYSTALLINE, 5, -3), e);
        CRYSTALLINE_HOE = register(new ModHoe(ExpertTiers.CRYSTALLINE, 0), e);
        CRYSTALLINE_PICK = register(new ModPick(ExpertTiers.CRYSTALLINE, 1, -2.8F), e);
        CRYSTALLINE_SAW = register(new ModSaw(ExpertTiers.CRYSTALLINE, 3, -3), e);
        CRYSTALLINE_SHOVEl = register(new ModShovel(ExpertTiers.CRYSTALLINE, 1.5F, -3), e);
        CRYSTALLINE_SWORD = register(new ModSword(ExpertTiers.CRYSTALLINE, 3, -2.4F), e);
        DIAMOND_DUST = register(new Item(new Item.Properties().group(ExpertModeCore.main)).setRegistryName("diamond_dust"), e);
        ...
        ELECTRUM_AXE = register(new ModAxe(ExpertTiers.ELECTRUM, 6, -3), e);
        ELECTRUM_HAMMER = register(new ModHammer(ExpertTiers.ELECTRUM, 6, -3), e);
        ELECTRUM_HOE = register(new ModHoe(ExpertTiers.ELECTRUM, -3), e);
        ELECTRUM_PICK = register(new ModPick(ExpertTiers.ELECTRUM, 1, -2.8F), e);
        ELECTRUM_SAW = register(new ModSaw(ExpertTiers.ELECTRUM, 3, -3), e);
        ELECTRUM_SHOVEl = register(new ModShovel(ExpertTiers.ELECTRUM, 1.5F, -3), e);
        ...
        FLINT_HOE = register(new ModHoe(ExpertTiers.FLINT, -3), e);
        ...
        LAPIS_DUST = register(new Item(new Item.Properties().group(ExpertModeCore.main)).setRegistryName("lapis_dust"), e);
        ...
        PRISMARINE_DUST = register(new Item(new Item.Properties().group(ExpertModeCore.main)).setRegistryName("prismarine_dust"), e);
        QUARTZ_DUST = register(new Item(new Item.Properties().group(ExpertModeCore.main)).setRegistryName("quartz_dust"), e);
