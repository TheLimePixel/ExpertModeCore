...
public class MachineRecipeAddition {
    public static void registry() {
        ...
        RecipeTypes.SAWMILL_RECIPES.recipeBuilder().input(new TagStack(ItemTags.OAK_LOGS)).output(new ItemStack(Blocks.OAK_PLANKS, 4)).time(100).highSignal().buildAndRegister();
        RecipeTypes.SAWMILL_RECIPES.recipeBuilder().input(new TagStack(ItemTags.BIRCH_LOGS)).output(new ItemStack(Blocks.BIRCH_PLANKS, 4)).time(100).highSignal().buildAndRegister();
        RecipeTypes.SAWMILL_RECIPES.recipeBuilder().input(new TagStack(ItemTags.SPRUCE_LOGS)).output(new ItemStack(Blocks.SPRUCE_PLANKS, 4)).time(100).highSignal().buildAndRegister();
